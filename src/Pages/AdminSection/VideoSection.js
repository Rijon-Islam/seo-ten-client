                        ...
                        <div class="col-lg-8 col-md-12">
                                ...
                                <form class="contact-form " onSubmit={handleVideoSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Update Video Section </button>
                                        </div>
                                    </div>
                            ...
                            <form class="contact-form" onSubmit={handleAddItem}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Add Team Member </button>
                                    </div>
                                </div>
