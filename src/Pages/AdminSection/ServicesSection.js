                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                                ...
                                <form class="contact-form " onSubmit={handleServiceSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Update Services </button>
                                        </div>
                                    </div>
                            ...
                            <h2 className='mt-100'>Add Service</h2>
                            <form class="contact-form" onSubmit={handleAddItem}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Add Service </button>
                                    </div>
                                </div>
                                        ...
                                        items.map(c => <div className="col-lg-4 col-md-6 col-sm-12 pb-70">
                                            <div className="item-single">
                                                ...
                                                <div className="item-content">
                                                    <Link to={`/service-edit/${c._id}`} className='theme-btn'>Edit Services</Link>
                                                    <h4>{c.serviceTitle}</h4>
