                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <form class="contact-form " onSubmit={handleBannerSection}>
                                    <div class="row">
                                        ...
                                        <div className="col-lg-12 col-md-12">
                                            <div className="form-group">
                                                <input type="text" className="form-control" name="sliderTextOne" defaultValue={banner.sliderTextOne} placeholder="Slider Text One" required />
                                            </div>
                                        </div>
                                        <div className="col-lg-12 col-md-12">
                                            <div className="form-group">
                                                <input type="text" className="form-control" name="sliderTextTwo" defaultValue={banner.sliderTextTwo} placeholder="Slider Text Two" required />
                                            </div>
                                        </div>


                                        <div class="slider-btn">
                                            <button class="theme-btn" data-animation="fadeInRight" data-delay=".8s">Update Banner</button>
                                        </div>
                                    </div>
