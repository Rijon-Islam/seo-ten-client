                       ...
                       <div class="container text-center">
                           <div class="row">
                               ...
                               <div class="col-lg-3  col-md-6 col-12">
                                   ...
                                   <div className='single-card'>
                                       <Link to='/add-pricing'> <img src={pricing} /> Pricing Setting</Link>
                                   </div>
                               </div>
                               ...
                               <div class="col-lg-3  col-md-6 col-12">
                                   <div className='single-card'>
                                       <Link to='/add-address-footer'> <img src={footerad} /> Company Address</Link>
                                   </div>
                               ...
                               <div class="col-lg-3  col-md-6 col-12">
                                   ...
                                   <div className='single-card'>
                                       <Link to='/add-social-footer'> <img src={footersocial} />Company Bio Social URL</Link>
                                   </div>
                               </div>
